...
| Below 5 files / 500 lines there is no funnel | The round trip costs more than it saves on a small input, and a rule with no threshold funnels everything | Always pre-filter | 2026-09-26 |
